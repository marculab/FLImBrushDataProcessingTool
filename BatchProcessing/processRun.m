...
function processRun(DataPath, BGPath, APD1Path, APD2Path, APD3Path, APD4Path, alpha1, alpha2, alpha3, alpha4, ChWidth, saveRootPath)
...
Ch4Color = [255,0,0]/255; % channel 3 plot color
upSampleFactor = 5;
bgLow = 540;
bgHigh = 900;
...
saveas(fFitting4,fullfile(saveRootPath,saveFolderName,'FittingCh4'),'fig');
close all
end