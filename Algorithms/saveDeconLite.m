...
Ch2DataObj = struct;
Ch3DataObj = struct;
VarList={'alpha', 'dataT', 'gain','irfIdx','Lg_INTs','Lg_INTsGainCorrected', 'K', 'LaguerreBasis', 'Lg_LCs','Lg_LTs','noise','SNR','Ph_H1S','Ph_H1G','Ph_H2S','Ph_H2G','Ph_H3S','Ph_H3G','Ph_H4S','Ph_H4G'};
for ii=1:3
